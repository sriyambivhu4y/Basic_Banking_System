...
<div class="container">
<h2 class="text-center pt-4" style="color: #000;border-bottom:2px solid black; ">ALL USERS</h2>
<br>
<div class="row">
<div class="col">
...
<td><a href="bank_transaction_to.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn mt-1 mb-0">View Details</button></a></td> 
</tr>
<?php
}
?>
